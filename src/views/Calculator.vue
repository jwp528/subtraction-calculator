    ...
    <v-flex lg3>
      <v-card class="mt-5">
        <v-card-title class="grey--text-darken-4">
          <v-text-field readonly flat :value="formula.data.symbols.join('')" label="Equation" outline reverse class="calc-field"  />
        </v-card-title>
        <v-card-text>
          ...
          <v-flex xs3>
            ...
            <v-flex xs3>
              <v-btn @click="removeLastSymbol" class="calc-field calc-btn"><v-icon>backspace</v-icon></v-btn>
            </v-flex>
            <v-flex xs3>
